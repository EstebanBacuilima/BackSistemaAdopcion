...
public class SolicitudAdopcionServiceImpl extends GenericServiceImpl<SolicitudAdopcion, Integer> implements SolicitudAdopcionService {
    ...
    @Override
    public List<SolicitudAdopcion> findBySoliPorMascotaUsuario(Integer idMascota, Integer idUsuario) {
        return solicitudDeAdopcionRepository.findBySoliPorMascotaUsuario(idMascota,idUsuario);
    }

    @Override
    public List<SolicitudAdopcion> findSolicitudesPorFundacion(Integer idFundacion) {
        return solicitudDeAdopcionRepository.findSolicitudesPorFundacion(idFundacion);
    }
